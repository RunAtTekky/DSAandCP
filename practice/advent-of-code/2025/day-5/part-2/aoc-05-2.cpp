...
ll find_total_fresh(vector<vector<ll>>& ranges, vector<ll> ingredients) {
    ll total = 0;
...
void solve() {
    ...
    ll total_fresh_ingredients = find_total_fresh(ranges, ingredients);
    cout << total_fresh_ingredients << "\n";
}
